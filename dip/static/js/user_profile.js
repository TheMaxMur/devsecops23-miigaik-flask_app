...
//editButton.addEventListener('click', (e) => { e.preventDefault(); openEditModal() }) //оригинал из девелопа

//Эта доработка больше не убивает кнопку РЕДАКТИРОВАТЬ на странице Профиля.
editButton.addEventListener('click', (e) => {
    ...
    if (e.source == window.opener) {
        ...
        console.warn('Unauthorized user-card edit sender');
    }
});
